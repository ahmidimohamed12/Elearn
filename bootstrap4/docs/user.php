	...
	<div class="wrapper">
		...
		<div class="main">
			...
			<main class="content">
				...
				if(isset($_POST['save']))
					{
						$sql = "INSERT INTO users (Name, loggin, passowrd,email,level,Dateinv,Role)
						VALUES ('".$_POST["Name"]."','".$_POST["loggin"]."','".$_POST["passowrd"]."','".$_POST["email"]."',0,'".$_POST["Dateinv"]."','".$_POST["Role"]."')";
...
<input type="text" class="form-control"  name="Name" placeholder="Name" />
        ...
        <div class="col-5">
<input type="text" class="form-control" name="loggin"  placeholder="Loggin" />
        </div>
                                    </div>
                                    <div  style="margin-top:20px;" class="row">
        <div class="col-4">
